# Week 3 講義：The Town Notice and the Guardian of the Dojo

**文法重點：** 名詞與冠詞（可數／不可數、a / an / the、數量詞 many / much / a few / a little）與 There is / There are 存在句  
**核心單字：** 14 個
...
> 1. **Protect the Town Wells:** Clean drinking water is important for every family. Do not drop any trash near public wells. If you see a dangerous stranger near wells, tell local guards.
> 2. **Large Crowd Safety:** A big crowd of visitors will arrive before dark. Please walk with care on the river bridge.
> 3. **Special Care for Patients:** If you have a sick family member or patient, there is a quiet resting room with clean water and medicine near the East Gate.

---

### Text B: Soryu Dojo Record & Conversation

Master Keizo sat in the quiet room of the Soryu Dojo. Outside, the evening air was **peaceful**, but the streets were already getting busy for the summer **event**. Keizo looked at Hakuji, his young student, who was carefully carrying fresh water to the bedroom.
...
Keizo nodded. "You have taken great care of my daughter since you arrived. You have great **skill**, but your real power is your heart to **protect** others."

Hakuji looked at his hands. Three years ago, he was alone and angry. But Master Keizo gave him a home and treated him like a son. "Master," Hakuji said, "I made a **promise** to Koyuki. When she can walk outside, I will carry her to the river so we can watch the **fireworks** together."

"That is a wonderful promise," Keizo said. "You are like the stone lion dog outside the temple. You always stand as a **guard** for those who are weak. There will be a large **crowd** tonight. If a **stranger** comes near our gate or our well, stay calm and keep everyone safe."

"I will, Master," Hakuji said firmly. "I will protect this dojo and Koyuki with my life."

---

## Part 2：Core Vocabulary 核心單字

| # | Word | POS | 中文意思 | Example |
| :---: | :--- | :--- | :--- | :--- |
...
| 8 | **event** | n. | 活動；重大事件 | The fireworks show is a popular summer event. |
...
## Part 4：Grammar - Nouns, Articles & "There is / There are"
...
| :--- | :--- | :--- | :--- |
| **很多** | **many** (many students) | **much** (much water) | **a lot of** / **lots of** |
| **一些** | **a few** (a few guards) | **a little** (a little medicine) | **some** (肯定句) / **any** (否定與疑問) |
| **很少 (幾乎沒有)** | **few** (few friends) | **little** (little time) | — |

> 💡 **快速口訣：**  
> - **`a few`** 配有 `-s` 的字（*a few books*）。  
> - **`a little`** 配沒有 `-s` 的字（*a little water*）。  
> - **`some`** 用在肯定句（*I have some water.*）；**`any`** 用在否定句與問句（*Do you have any questions?*）。
...
### 4. 存在句型：`There is` vs `There are`（「有……」）

表達「某個地方存在某物」時，使用 `There is / There are`，**不要**跟 `have / has` 混淆！

| 句型 | 適用名詞 | 例句 |
| :--- | :--- | :--- |
| **There is + 單數可數名詞** | 單數一個 | **There is a guard** at the gate.（大門口有一位守衛。） |
| **There is + 不可數名詞** | 液體／抽象／無複數 | **There is clean water** in the well.（水井裡有乾淨的水。） |
...
### B. Complete with "There is" or "There are", then fix the mistakes
...
## Part 6：Speaking & Discussion - The Promise & Safety Patrol

### Activity 1: Town Safety Inspection (運用 There is / There are 與數量詞)

想像你與同學是江戶祭典的巡守隊員。輪流觀察以下地點，用 `There is...` 或 `There are...` 描述你們看到的狀況：
...
## Homework：Vocabulary Review Quiz

### A. Match the words with their meanings

1. `protect` 　　A. 藥品；藥物 (不可數)  
2. `patient` 　　B. 和平的；平靜的  
3. `medicine`　　C. 康復；恢復健康  
4. `peaceful`　　D. 保護；防衛  
5. `recover` 　　E. 病人；有耐心的  

---

### B. Choose a word from the box to complete the sentence
...
15. *Hakuji promised to protect Koyuki.*  
    ➔ __________________________________________________  
16. *水井裡有許多乾淨的水。 (提示：There is...)*  
    ➔ __________________________________________________  
