...
## Quest 1: Read with a Job

今天不是把每句都翻成中文。你的任務是找出三件事：

1. **Goal:** The team wants to do what?
2. **Rules:** What can or can't they do?
3. **Best move:** What should they do next?

讀完每一份文字，就把證據放進表格。

---

## Quest 2: Core Vocabulary

| # | Word | Level | 中文 | Easy link |
| :---: | :--- | :---: | :--- | :--- |
| 1 | **choose** | 1200 | 選擇 | choose one door |
| 2 | **enter** | 1200 | 進入 | enter the room |
| 3 | **follow** | 1200 | 跟隨；遵守 | follow the rules |
| 4 | **rule** | 1200 | 規則 | read every rule |
| 5 | **danger** | 800 | 危險 | a sign of danger |
| 6 | **direction** | 800 | 方向；指示 | read the directions |
| 7 | **message** | 800 | 訊息 | send a message |
| 8 | **protect** | 800 | 保護 | protect your team |
| 9 | **secret** | 800 | 秘密的；祕密 | a secret door |

### Build the quest path

從上表選字完成流程，每字只用一次。

`read the __________ → follow each __________ → enter the room → see __________ → protect the team → choose the __________ door`

---

## Quest 3: CAP Reading - Three Texts, One Decision
...
> #### BEFORE YOU ENTER
>
> 1. Enter with your team.
> 2. Follow the red signs first.
> 3. Do not touch a black box.
> 4. A blue light means danger. Stop and read the wall.
> 5. You can ask for one direction.
> 6. You cannot go back after you choose the secret door.
...
| Read for... | Evidence from the texts |
| :--- | :--- |
| Team goal | ______________________________________________ |
| One thing they can do | ______________________________________________ |
| One thing they can't do | ______________________________________________ |
| Best door now | ______________________________________________ |
...
## Quest 4: Grammar Tools for a Team

### Tool A - Command: 動詞放句首

| Use | Pattern | Example |
| :--- | :--- | :--- |
| 要對方做 | **動詞原形** + ... | **Follow** the red signs. |
| 要對方別做 | **Don't + 動詞原形** + ... | **Don't touch** the box. |

命令句常省略 `you`。不要寫 `You follow...` 來當規則標題。

### Tool B - Let's: 提議大家一起做

> **Let's + 動詞原形.**

- **Let's read** the wall.
- **Let's choose** the left door.

`Let's` 包含說話的人，意思是「我們一起……吧」。

### Tool C - can / can't: 能不能、可不可以

> **主詞 + can / can't + 動詞原形**

- We **can ask** for one direction.
- We **can't go** back.

`can` 後面不要加 `to`，動詞也不要加 `-s` 或 `-ing`。
...
## Quest 5: Grammar in Action

### A. Complete the rule card

Word bank: `enter` `follow` `touch` `read` `choose`

1. ____________________ with your team.
2. ____________________ the red signs first.
3. Don't ____________________ the black box.
4. ____________________ the wall when you see a blue light.
5. Don't ____________________ a door too fast.

### B. Choose the best answer

1. The team ______ ask for one direction.

   A. can　B. cans　C. can to　D. is can

2. “We need more information.” “______ read Leo's message again.”

   A. Don't　B. Let's　C. Can　D. Are

3. The players cannot ______ after they choose the secret door.

   A. went back　B. going back　C. go back　D. goes back

4. ______ the directions before you enter.

   A. Reads　B. Reading　C. To read　D. Read

5. The blue light means danger. ______ choose a door now.

   A. Don't　B. Doesn't　C. Can't to　D. Not
...
1. Command: _________________________________________________________________
2. Negative command: ________________________________________________________
3. Let's: ___________________________________________________________________
4. Can / can't: _____________________________________________________________

---

## Homework: Retrieve, Read, Decide
...
1. ______ the wall. (read)
2. Don't ______ the black box. (touch)
3. Let's ______ the red signs. (follow)
4. Mia can ______ maps. (read)
5. The team can't ______ back. (go)

### D. CAP mini-item

> **New rule:** The first player can read the map, but cannot speak. The other players can ask yes/no questions.
