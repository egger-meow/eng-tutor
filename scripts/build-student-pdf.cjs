...
body { font-family: "Microsoft JhengHei", "Noto Sans CJK TC", Arial, sans-serif; color: #172033; font-size: 10.2pt; line-height: 1.4; }
h1 { color: #173b69; font-size: 20pt; margin: 0 0 8px; padding-bottom: 7px; border-bottom: 3px solid #4f83bd; }
h2 { color: #173b69; font-size: 14.5pt; margin: 15px 0 7px; padding: 5px 8px; border-left: 5px solid #4f83bd; background: #eef5fc; break-after: avoid; }
h3 { color: #294e78; font-size: 12pt; margin: 11px 0 5px; break-after: avoid; }
p { margin: 5px 0; }
hr { border: 0; border-top: 1px solid #b8c6d6; margin: 15px 0; }
blockquote { margin: 8px 0; padding: 8px 12px; border-left: 4px solid #77a4d3; background: #f4f8fc; break-inside: avoid; }
